...
public class CodeGenerator {
    public static void main(String[] args) {
        //获取项目所在路径
        String path = System.getProperty("user.dir")+ "/Pet";
        String url = "jdbc:mysql://localhost:3306/pet?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
        ...
        FastAutoGenerator.create(new DataSourceConfig.Builder(url, username, password)
                ...
                .globalConfig(builder -> {
                    builder.author("PetAuthor") // 设置作者
                            .fileOverride()// 覆盖已生成文件
                            .outputDir(path + "/src/main/java")
                            .enableSwagger() //swagger注解
                            .build(); // 指定输出目录

                })
                // 包配置(PackageConfig)
                .packageConfig(builder -> {
                    builder.parent("com.pet") // 设置父包名
                            .mapper("mapper")
                            .entity("pojo")
